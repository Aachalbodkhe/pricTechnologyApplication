...
public class LockedMessage extends Base_Class implements ITestListener {
		...
		public void onStart(ITestContext context) {
			spark=new ExtentSparkReporter("./Extent_Report/Create_Locked Report.html");
			//configure the spark reporter
			spark.config().setDocumentTitle("Create_Locked Report");
