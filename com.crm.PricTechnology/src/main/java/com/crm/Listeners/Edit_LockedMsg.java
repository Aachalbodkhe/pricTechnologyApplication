...
public class Edit_LockedMsg extends Base_Class implements ITestListener{
		...
		public void onStart(ITestContext context) {
			         ...
			         spark=new ExtentSparkReporter("./Extent_Report/Edit_Msg Report.html");
			//configure the spark reporter
			spark.config().setDocumentTitle("Edit_Msg Report");
